...
module.exports = function Base(options) {
  return {
     ...
     *                             `function(err, queue){}`
     */
    connect: new NotImplementedError,
    /**
     * Terminate communication with the lock.
     * @param  {Function} callback The function, that will be called when this action is completed. [optional]
     *                             `function(err){}`
     */
    disconnect: new NotImplementedError,
    /**
     ...
     */
    publish: new NotImplementedError,
    /**
     ...
     */
    subscribe: new NotImplementedError,
    /**
     ...
     */
    startHearbeat: new NotImplementedError,
    /**
     * Heartbeat stop.
     */
    stopHeartbeat: new NotImplementedError
  };
}
